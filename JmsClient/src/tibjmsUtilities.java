 ...
 * 
 * $Id: tibjmsUtilities.java 38412 2008-11-14 20:58:24Z $
 * 
 */
...
public class tibjmsUtilities
{
    ...
    /**
     * This method creates a java.Security.SecureRandom object.
     * Please note that this uses the highest-priority installed provider
     * that has a SecureRandom implementation.  If a specific implementation
     * is required, set the properties accordingly or use the getInstance
     * method to specify that implementation.
     */
...
private static class SSLParams implements com.tibco.tibjms.TibjmsSSLHostNameVerifier {
        ...
        public void init() throws JMSSecurityException {
            ...
            com.tibco.tibjms.TibjmsSSL.setSecureRandom(createSecureRandom());
        }
